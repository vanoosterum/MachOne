...
if browser.is_text_present('Dashboard', wait_time=15):
    ...
    print "Log In Failed"
browser.find_by_id('SearchHistoryDropdown').first.click()
if browser.is_text_present('Search', wait_time=15):
    print "Search History Selection Passed"
else:
    print "Search History Selection Failed"
